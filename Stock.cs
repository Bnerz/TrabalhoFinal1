...
namespace Projeto_Final_1___L_Programação
{
    public class Stock
    {
        ...
        {
            var listaItemStock = ObterListaItemStock();
            var itemStock = listaItemStock.Single(x => x.Prod.Id == idProduto); //Single que pode ser usado para retornar somente um elemento em uma sequência que satisfaça uma condição específica.
